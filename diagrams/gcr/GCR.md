...
flowchart TD
    ...
    START --> EXTRACT[Extract native payload<br/>tx.content.data]
    EXTRACT --> PARSE[Parse INativePayload<br/>"native", payload]
    ...
    subgraph "Send Native Tokens"
        SEND --> EXTRACTARGS[Extract args<br/>to: address, amount: bigint]

        EXTRACTARGS --> CREATEEDITS[Create 2 GCREdits]

        CREATEEDITS --> EDIT1[Edit 1: Remove from sender]
        CREATEEDITS --> EDIT2[Edit 2: Add to receiver]

        EDIT1 --> EDIT1DETAILS["{<br/>  type: 'balance',<br/>  operation: 'remove',<br/>  account: tx.content.from,<br/>  amount: amount,<br/>  txhash: tx.hash,<br/>  isRollback: false<br/>}"]

        EDIT2 --> EDIT2DETAILS["{<br/>  type: 'balance',<br/>  operation: 'add',<br/>  account: to,<br/>  amount: amount,<br/>  txhash: tx.hash,<br/>  isRollback: false<br/>}"]

        EDIT1DETAILS --> ARRAYEDITS[edits = edit1, edit2]
    ...
    LOOPEDITS --> APPLYEDIT1[Apply Edit 1: Remove balance]
    APPLYEDIT1 --> CHECKEDIT1{Edit 1<br/>success?}

    CHECKEDIT1 -->|no| ROLLBACK[Rollback all edits]
    CHECKEDIT1 -->|yes| APPLYEDIT2[Apply Edit 2: Add balance]
